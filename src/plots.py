...
# Plot class for WGI, EI, Leader GE, Bar FA, Regression, and Residuals.
class Plot:
    """Example Usage:
        plotter = plots.Plot()
    ...
    # Perfrom WGI plot for three indicator codes.
    ...
    # Perform EI for niger of time period regarding GDP, Inflation, and Unemployment.  
    def plot_ei(self, df):
        """
